...
GPIO7 elbow and GPIO8 wrist sensitivity are **4x**: a 5-degree change from your reference requests a 20-degree servo change before optional smoothing. GPIO6 retains 1x gain. Claw gain is **10x**, five times its previous 2x response. Keyboard steps are 7 servo degrees. Rotating the whole right forearm without bending the wrist does not change the wrist's relative angle.
