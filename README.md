...
GPIO6 left-hand rotation, GPIO7 elbow, and GPIO8 wrist sensitivity are **4x**: a 5-degree change from your reference requests a 20-degree servo change before optional smoothing. Claw gain is **5x**, reduced twentyfold from the previous 100x setting. Keyboard steps are 7 servo degrees. Rotating the whole right forearm without bending the wrist does not change the wrist's relative angle.
