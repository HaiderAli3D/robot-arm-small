...
echo Starting Robot Arm on %ROBOT_ARM_PORT%...
echo Click the camera window to use the controls. Space starts or pauses; Q quits.
echo.
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\run.ps1" -Port "%ROBOT_ARM_PORT%"
if errorlevel 1 (
    echo.
